...
bool ActionLogout::parseToStruct(std::shared_ptr<char> newPayload)
{
	payload = newPayload;
	payload_size = 0;
...
bool ActionLogout::parseToPayload()
{
	unsigned int add;
	payload_size = 0;
	if (!payload)
...
bool ActionLogout::response_parseToStruct(std::shared_ptr<char> newPayload)
{
...
bool ActionLogout::response_parseToPayload()
{
	unsigned int add;
	response_size = 0;
	if (!response_payload)
